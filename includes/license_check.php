...
class ExchangeBridgeLicenseVerifier {
    ...
    public function verifyLicense() {
        ...
        // Validate license key format - Updated to accept your format
        if (!$this->isValidLicenseKeyFormat($this->licenseKey)) {
    ...
    /**
     * Validate license key format - Updated for your license format
     */
    private function isValidLicenseKeyFormat($licenseKey) {
        // Accept your format: EB-S65MG-V84H5-QQNDF-DDAHC (26 characters)
        // Or longer format: 32+ characters
        if (strlen($licenseKey) >= 24 && preg_match('/^[A-Za-z0-9\-]+$/', $licenseKey)) {
            // Check if it starts with EB- or is longer than 30 chars
