...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty(trim($title))) {
        ...
        $existingPost = $db->getRow("SELECT id FROM blog_posts WHERE slug = ?", [$slug]);
        if ($existingPost) {
            ...
            try {
                ...
                if ($postId) {
                    ...
                    $_SESSION['error_message'] = 'Failed to add blog post to database';
                    
                    // Clean up uploaded files if database insert failed
                    if (!empty($featuredImage) && file_exists($uploadDir . $featuredImage)) {
...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="add.php" method="POST" enctype="multipart/form-data" accept-charset="UTF-8" id="addPostForm">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" class="form-control blog-content" required placeholder="Enter post title" value="<?php echo isset($_POST['title']) ? htmlspecialchars($_POST['title'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="slug">Slug <span class="text-danger">*</span></label>
                                <input type="text" name="slug" id="slug" class="form-control" required value="<?php echo isset($_POST['slug']) ? htmlspecialchars($_POST['slug'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="slug-preview" id="url-preview">../../blog-single.php?slug=</div>
                    </div>
                    
                    <div class="form-group">
                        <label for="excerpt">Excerpt</label>
                        <textarea name="excerpt" id="excerpt" class="form-control blog-content" rows="3" placeholder="Brief description of the post"><?php echo isset($_POST['excerpt']) ? htmlspecialchars($_POST['excerpt'], ENT_QUOTES, 'UTF-8') : ''; ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="editor-container">
                            <textarea name="content" id="content" class="form-control blog-content" rows="10" required><?php echo isset($_POST['content']) ? htmlspecialchars($_POST['content'], ENT_QUOTES, 'UTF-8') : ''; ?></textarea>
                        </div>
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="meta_title" id="meta_title" class="form-control blog-content" placeholder="SEO optimized title" value="<?php echo isset($_POST['meta_title']) ? htmlspecialchars($_POST['meta_title'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                            </div>
                            
                            <div class="form-group">
                                <label for="meta_description">Meta Description</label>
                                <textarea name="meta_description" id="meta_description" class="form-control blog-content" rows="2" placeholder="Brief description for search engines"><?php echo isset($_POST['meta_description']) ? htmlspecialchars($_POST['meta_description'], ENT_QUOTES, 'UTF-8') : ''; ?></textarea>
                            </div>
                            
                            <div class="form-group">
                                <label for="meta_keywords">Meta Keywords</label>
                                <input type="text" name="meta_keywords" id="meta_keywords" class="form-control blog-content" placeholder="keyword1, keyword2, keyword3" value="<?php echo isset($_POST['meta_keywords']) ? htmlspecialchars($_POST['meta_keywords'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                    ...
                    <div class="form-group mt-4">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save mr-2"></i>Add Post
                        </button>
    ...
    <div class="col-lg-4">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <div id="seo-preview">
                    <div class="text-muted">Fill in title and meta description to see SEO preview...</div>
                </div>
            </div>
        </div>
    </div>
