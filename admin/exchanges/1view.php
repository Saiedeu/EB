                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                <th>Last Updated:</th>
                                <td><?php echo date('Y-m-d H:i:s', strtotime($exchange['updated_at'])); ?></td>
                            </tr>
                            <tr>
                                <th>Status:</th>
                                <td>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <a href="https://wa.me/<?php echo preg_replace('/[^0-9]/', '', getSetting('contact_whatsapp', '8801869838872')); ?>?text=<?php echo urlencode('Hello! Regarding transaction: ' . $exchange['reference_id']); ?>" class="btn btn-success btn-block" target="_blank">
