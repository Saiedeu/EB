...
if ($_POST && isset($_POST['action']) && $_POST['action'] === 'update_terms_page') {
    if (verifyCSRFToken($_POST['csrf_token'])) {
        ...
        $result = $db->update('pages', $updateData, 'slug = ?', ['terms']);
        
        if ($result && !isset($_SESSION['error_message'])) {
            $_SESSION['success_message'] = 'Terms & Conditions updated successfully!';
        } elseif (!isset($_SESSION['error_message'])) {
            $_SESSION['error_message'] = 'Failed to update Terms & Conditions. Please try again.';
        }
...
$termsPage = getPageBySlug('terms');
if (!$termsPage) {
    // Create default terms page if doesn't exist
    $db->insert('pages', [
        'slug' => 'terms',
        'title' => 'Terms & Conditions',
        'content' => '<h2>Terms & Conditions</h2><p>Welcome to our Terms & Conditions page. By using our services, you agree to comply with and be bound by the following terms and conditions.</p><p>Please add your terms and conditions content here.</p>',
        'meta_title' => 'Terms & Conditions - ' . getSetting('site_name', 'Exchange Bridge'),
...
<div class="card mb-4">
    <div class="card-header">
        <i class="fas fa-file-contract mr-1"></i> Edit Terms & Conditions
        <a href="<?php echo SITE_URL; ?>/terms.php" target="_blank" class="btn btn-info btn-sm float-right ml-2">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="" enctype="multipart/form-data" accept-charset="UTF-8" id="termsPageForm">
            <input type="hidden" name="action" value="update_terms_page">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" class="form-control page-content" 
                               value="<?php echo htmlspecialchars($termsPage['title'] ?? 'Terms & Conditions', ENT_QUOTES, 'UTF-8'); ?>" 
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" value="terms.php" readonly>
                        </div>
            ...
            <div class="form-group">
                <label for="content">Terms & Conditions Content <span class="text-danger">*</span></label>
                <textarea name="content" id="content" class="form-control page-content" rows="15" required><?php echo htmlspecialchars($termsPage['content'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="meta_title" id="meta_title" class="form-control page-content" 
                                       value="<?php echo htmlspecialchars($termsPage['meta_title'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php if (!empty($termsPage['featured_image'])): ?>
                                    <div class="mt-2">
                                        <img src="<?php echo SITE_URL; ?>/assets/uploads/seo/<?php echo htmlspecialchars($termsPage['featured_image']); ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="meta_description" id="meta_description" class="form-control page-content" 
                                  rows="3" placeholder="Brief description for search engines"><?php echo htmlspecialchars($termsPage['meta_description'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="meta_keywords" id="meta_keywords" class="form-control page-content" 
                               value="<?php echo htmlspecialchars($termsPage['meta_keywords'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
                               placeholder="terms, conditions, agreement, policy">
...
<script>
// Same configuration as privacy page with identical functionality
// Get current directory path for upload handler
const currentPath = window.location.pathname;
const basePath = currentPath.substring(0, currentPath.lastIndexOf('/')) + '/';

// Enhanced TinyMCE initialization - Same as privacy page
tinymce.init({
    selector: '#content',
    height: 500,
    language: 'en',
...
$(document).ready(function() {
    ...
    // Media selection functionality - Same as privacy page
    ...
    $('#termsPageForm').on('submit', function(e) {
        tinymce.triggerSave();
...
// Character count functions - Same as privacy page
