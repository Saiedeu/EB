...
<main class="flex-grow container mx-auto p-4 md:p-6">
    ...
    <!-- Two Column Layout - FIXED: Proper 3:1 ratio for desktop -->
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <!-- Right Column (1/4 width) - FIXED: Proper sidebar positioning -->
...
<!-- Enhanced CSS for Tutorial Carousel -->
<style>
/* Base Styles */
.payment-icon {
    display: flex;
...
@media (max-width: 1024px) {
    /* On mobile/tablet, show sidebar content first */
    .lg\:order-1 {
        order: 2;
    }
    .lg\:order-2 {
